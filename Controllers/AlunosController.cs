...
namespace GestaoEscolar.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public AlunosController(GestaoEscolarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Alunos != null ? 
                          ...
                          Problem("Entity set 'GestaoEscolarContext.Alunos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Idade,Turma")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Idade,Turma")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GestaoEscolarContext.Alunos'  is null.");
            }
            var alunos = await _context.Alunos.FindAsync(id);
            if (alunos != null)
            {
